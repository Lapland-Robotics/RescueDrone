...
public class DroneConnection extends Application {
    ...
    /**
     * This function is used to get the instance of DJIRemoteController.
     * If no product is connected, it returns null.
     */
    public static synchronized RemoteController getRemoteConInstance() {
        Aircraft tmp = getAircraftInstance();
        if (tmp == null) {
            return null;
        }
        return tmp.getRemoteController();
    }
     ...
     * If no product is connected, it returns null.
     */
    public static synchronized FlightController getFlightConInstance() {
        Aircraft tmp = getAircraftInstance();
        if (tmp == null) {
            return null;
        }
        return tmp.getFlightController();
    }
